...
val OutputFormatSelector =
    FC<OutputFormatSelectorProps> { props ->
...
private fun ChildrenBuilder.buildImportWarnings(props: OutputFormatSelectorProps) {
    val importWarnings =
        props.projects.flatMap { project: Project ->
...
private val ImportWarning.text: String
    get() =
        when (this) {
            ...
            is ImportWarning.TempoIgnoredInFile ->
                string(
            ...
            is ImportWarning.TempoIgnoredInTrack ->
                string(
            ...
            is ImportWarning.TempoIgnoredInPreMeasure ->
                string(
                    Strings.ImportWarningTempoIgnoredInPreMeasure,
                    "bpm" to tempo.bpm.toString(),
                )
            is ImportWarning.DefaultTempoFixed ->
                string(
            ...
            is ImportWarning.TimeSignatureIgnoredInTrack ->
                string(
            ...
            is ImportWarning.TimeSignatureIgnoredInPreMeasure ->
                string(
                    Strings.ImportWarningTimeSignatureIgnoredInPreMeasure,
                    "timeSignature" to timeSignature.displayValue,
                )
            is ImportWarning.IncompatibleFormatSerializationVersion ->
                string(
